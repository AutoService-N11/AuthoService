...
{
    public class DeleteServiceCategoryCommandHandler : IRequestHandler<DeleteSeateBrandCommand, ResponceModel>
    {
        ...
        public async Task<ResponceModel> Handle(DeleteSeateBrandCommand request, CancellationToken cancellationToken)
        {
